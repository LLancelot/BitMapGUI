...
class GUI1():
    def __init__(self, MAP:BitmapData):
        ...
        self.entry = Entry(frame1, width = 40)
...
class window():
    def __init__(self):
        ...
        welcome = Label(frame1, text="Welcome to BitMaps Management System", font=("Helvetica", 16))
...
def main():
    ...
    if window().windowsubmit_func() == 1:
        GUI1(map1)
    elif window().windowsubmit_func() == 2:
        GUI2(map1)
